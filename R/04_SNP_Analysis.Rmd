...
- After loading the data from the previous section, an additional fitering step was performed, where SNPs where required have a non-zero MAF in the initial 1996 population.
