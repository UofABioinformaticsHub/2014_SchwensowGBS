...
```{r, fig.cap="*Comparison of library sizes before and after alignment. Given the filtering of alignments, this shows an acceptable rate of alignment across all samples*", fig.width=12, fig.height=14}
list(
  readTotals(deMuxFqc) %>%
...
```{r, fig.cap="*Difference in GC content when comparing each sample to Theoretical GC content from sampling the O. cuniculus genome.*", fig.height=10, fig.width=10}
