...
```{r plotLibComparison, fig.cap="*Comparison of library sizes after demultiplexing using sabre (salmon), vs the original method using process_radtags from the stacks pipelin (blue).*"}
list(
    origFqc %>%
        readTotals() %>%
