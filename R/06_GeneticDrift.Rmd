...
2. A starting minor allele frequency was selected as one of *f~0~* = `r pander(f0)`. Each rabbit was simulated as heterozygous or homozygous for either the major or minor allele using the initial starting frquency
